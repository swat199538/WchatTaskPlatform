...
class PartnerModel extends BaseModel
{
    ...
    protected $updateFields = array('id', 'email', 'remark', 'status', 'password', 'new_password', 'new_password_confirmation');
    ...
    {
        return $this->field('id, username, email, remark, last_logged_at, last_logged_ip, status')->limit("$startNo, $pageSize")->select();
    }
    ...
    public function loginCheck($data)
    {
        ...
        $userData = $this->field('id, username, password')->where("username='%s'", array($username))->find();
